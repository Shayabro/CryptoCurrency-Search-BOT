...
async def get_stocks():
    ...
    async with pool.acquire() as connection:
        ...
        symbol_urls = {}
        for stock in stocks:
            symbol_urls[stock['id']] = f"https://api.polygon.io/v2/aggs/ticker/X:{stock['symbol']}USD/range/5/minute/2021-06-01/2021-08-10?apiKey={config.POLYGON_API_KEY}&limit=50000"
